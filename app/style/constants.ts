...
export const STYLE_REVISIT_KEY      = "style:revisit";    // 마이헤어 "결과지 다시 보기" 1회성 플래그 — 저장된 진단 재조립(합성·폴링·quota 없음)
// (STYLE_PREWARM_KEY 제거 — GPU 예열은 /style 레이아웃 세션핑(StyleSessionPing) 90초 하트비트가 전담. sessionStorage 공유 불필요.)
