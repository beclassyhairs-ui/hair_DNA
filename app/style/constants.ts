...
export const STYLE_GENERATED_KEY  = "style:generated"; // Replicate AI 생성 이미지 URL
export const STYLE_DEBUG_ERROR_KEY = "style:debugError"; // AI 합성 실패 시 실제 에러 메시지 (임시 디버그)
