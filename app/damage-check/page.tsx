  ...
  return (
    <div className="relative min-h-screen">
      ...
      <Link
        href="/home"
        aria-label="홈으로"
        className="absolute left-3 top-3 z-10 flex h-12 w-14 items-center justify-center rounded-full text-ink-2 transition-colors hover:bg-soft hover:text-ink active:scale-95"
      >
      ...
      <main className="mx-auto flex min-h-screen max-w-[430px] flex-col items-center justify-center px-page py-10 text-ink">
        ...
        >
          ...
          {/* 히어로 — 상한 결 1장(정사각·라벨 없음). 2장 세로배치가 무거워 1장으로 축소(C-2).
              healthy 이미지는 삭제하지 않고 미참조로 남긴다(추후 릴스 소재). */}
          <div className="relative mt-5 aspect-square w-full max-w-[260px] overflow-hidden rounded-2xl bg-soft shadow-soft">
            <Image
              src="/images/damage-hero-damaged.png"
              alt="상한 모발 결 견본"
              fill
