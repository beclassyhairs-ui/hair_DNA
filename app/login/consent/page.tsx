  ...
  return (
    <div className="flex items-start gap-3 border-b border-line py-3 last:border-b-0">
      <button
        ...
        aria-label={label}
        className="flex min-h-12 min-w-14 items-center justify-center"
      >
        <span
  ...
  return (
    <main className="mx-auto min-h-screen max-w-[430px] px-page py-8">
      ...
      <button
        ...
        className="mt-6 flex min-h-12 w-full items-center gap-3 rounded-btn border border-line bg-card px-4 py-3 text-left shadow-soft"
      >
        <span
      ...
      <Link
        href="/"
        className="mt-3 flex min-h-12 items-center justify-center text-aux text-sub active:text-ink"
      >
        취소하고 돌아가기
      </Link>
    </main>
