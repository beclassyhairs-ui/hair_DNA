    ...
    return (
      <section className="rounded-2xl bg-card p-4 shadow-soft">
        ...
        <div className="mt-3 text-right">
          <Link
            href="/style"
            className="inline-flex min-h-12 items-center justify-end text-body font-semibold text-ink transition-colors active:text-sub"
          >
            내 스타일 찾기 →
          </Link>
        </div>
...
export default function HomePage() {
  ...
  return (
    <AppShell>
      ...
      <Link
        href="/my-diary"
        className="flex min-h-12 items-center justify-center gap-1.5 py-2 text-center text-aux text-sub transition-colors active:text-ink"
      >
