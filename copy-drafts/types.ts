...
// ─── 도메인·블록 (§7-1 저장 구조 그대로) ────────────────────────────────────
export const STYLE_BLOCKS = ["volume", "hair-structure", "curl-fit", "cut", "safety"] as const;
...
export interface CopyEntry<E extends EvidenceKey = EvidenceKey> {
