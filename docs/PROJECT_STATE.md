...
## 🔴→🟢 F. 오픈 전 최종 검수 — 폴백 죽은경로 회귀 수정 + 정합 하네스 (2026-09-08, 커밋 완료·미push)

오픈 직전 8/16 이후 변경분 전수 검수. 🔴 1건 발견·수정, 나머지 통과. **다음 = 사업주 push 승인.**
...
- 🔴 **다음 = 사업주 push 승인**(2커밋 `46ed39a`·`1dabfb2` 한 번에). ⚪·🟡 잔여(masterData 7건·미참조 이미지2·debug-sentry·mature PNG·폰트 이원화·설문 이탈·문의 http)는 판정대로 오픈 후.
